...
echo "cd /etc/adm-lite && bash ./menu" > /bin/msc
...
echo -e "${cor[1]} \033[0;34m=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠"
echo -e "${cor[2]} ("Procedimento con exito!")"
echo -e "${cor[1]} \033[0;34m=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠"
echo -e "${cor[2]} |☆| ${cor[3]} ("Ahora Su VPS esta con un Menu Instalado")"
funcao_verificacao > /dev/null 2>&1
echo -e "${cor[1]} \033[0;34m=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠"
echo -e "${cor[2]} ("Use los Comandos"): menu, msc, adm"
echo -e "${cor[2]} ("Dale un buen uso!")"
echo -e "${cor[1]} \033[0;34m=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠"
echo -ne " \033[0m"
}
...
echo -e "${cor[1]} \033[0;34m=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠"
echo -e "${cor[1]} \033[1;32mSELECCIONAR IDIOMA ARGENTINO\n${cor[1]} \033[0;34m=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠\n${cor[2]} [1]-ESPAÑOL"
echo -e "${cor[1]} \033[0;34m=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠"
echo -ne " OPCIÓN: "; read lang
case $lang in
3)
id="pt"
;;
...
echo -e "${cor[2]} ""\n\033[1;37m  SCRIPT-GRATIS-NATH"
echo -e ""
echo -e "${cor[1]} \033[0;34m=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠"
echo -e "${cor[2]} "INSTALANDO SCRIPT-GRATIS-NATH" "
echo -e "${cor[1]} \033[0;34m=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠"
